...
fun rememberLiveNestControllerStack(
    ...
    val sweepAngleStateStack: List<SweepAngleState> =
        remember(maxNestingDepth) {
    ...
    val hitTests: List<HitResult?> =
        nestStack.mapIndexed { idx, level ->
            val isRoot = idx == 0
...
//            val previousLiveNestCircles = scaledCircles[idx -1]
            ...
            val snapToCenterPos =
                currentPoint.liveNestSnapsToFingerPosition ?: defaultPoint.liveNestSnapsToFingerPosition
