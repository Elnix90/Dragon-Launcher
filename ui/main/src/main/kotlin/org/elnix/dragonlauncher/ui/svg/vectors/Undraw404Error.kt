...
fun undraw404Error(): ImageVector =
    Builder(
        ...
        defaultHeight = 571.15.dp,
        viewportWidth = 860.13f,
        viewportHeight = 571.15f
    ).apply {
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M435.7,160.5c-7.7,-12.7 -16.8,-26.2 -31,-30.4 -16.5,-4.8 -33.4,4.7 -47.8,14.1a1392.2,1392.2 0,0 0,-123.9 91.3l0,0.5q46.2,-3.2 92.5,-6.4c22.3,-1.5 45.3,-3.3 65,-13.8 7.5,-4 14.7,-9.3 23.2,-9.7 10.5,-0.5 19.7,6.9 26.9,14.6 42.6,45.4 54.9,114.8 102.7,154.6A1517,1517 0,0 0,435.7 160.5Z"
                    ).toNodes(),
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M245,191.4c-1.4,-1.6 -2.9,-3.2 -4.3,-4.8 -11.4,-12.6 -23.7,-25.1 -39.4,-32.4a57.1,57.1 0,0 0,-23.9 -5.6c-8.6,0 -16.9,2.3 -24.8,5.4 -3.7,1.5 -7.4,3.2 -11,5 -4.1,2.1 -8.2,4.3 -12.2,6.5q-11.3,6.3 -22.4,13.1 -22,13.6 -42.6,29.2 -10.7,8.1 -20.9,16.8 -9.5,8 -18.7,16.5c-1.3,1.2 -3.3,-0.7 -1.9,-1.9 1.6,-1.5 3.2,-3 4.9,-4.5q6.9,-6.2 14,-12.2 12.9,-10.9 26.6,-21 21.2,-15.7 43.8,-29.2 11.3,-6.8 22.9,-13c2.3,-1.3 4.7,-2.5 7.1,-3.6a113.1,113.1 0,0 1,16.9 -6.9,60 60,0 0,1 25.5,-2.5 66.3,66.3 0,0 1,23.5 8.1c15.4,8.6 27.4,21.9 39,34.9C248.1,190.8 246.2,192.7 245,191.4Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M196.4,170.1c-18.8,-9.6 -42.8,-7.8 -60,4.3a855.9,855.9 0,0 1,97.4 22.7C220.5,189.3 210.1,177.1 196.4,170.1Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M136.3,174.4l-3.6,2.9c1.2,-1 2.5,-2 3.8,-2.9C136.4,174.4 136.3,174.4 136.3,174.4Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M661.6,322.4c-3.6,-4.4 -7.6,-9.1 -13,-10.9l-5.1,0.2A575.4,575.4 0,0 0,796.8 487Q729.2,404.7 661.6,322.4Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M346.2,285.9A37.5,37.5 0,0 0,361.1 306.9c2.8,1.9 6.2,3.8 7.1,7a8.4,8.4 0,0 1,-0.9 6.2,24.9 24.9,0 0,1 -3.9,5l-0.1,0.5c-7,-4.2 -13.7,-9.4 -17.5,-16.6s-4.4,-16.5 0.3,-23.2"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M579.2,488.9A37.5,37.5 0,0 0,594.1 509.9c2.8,1.9 6.2,3.8 7.1,7a8.4,8.4 0,0 1,-0.9 6.2,24.9 24.9,0 0,1 -3.9,5l-0.1,0.5c-7,-4.2 -13.7,-9.4 -17.5,-16.6s-4.4,-16.5 0.3,-23.2"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M114.2,474.9A37.5,37.5 0,0 0,129.1 495.9c2.8,1.9 6.2,3.8 7.1,7a8.4,8.4 0,0 1,-0.9 6.2,24.9 24.9,0 0,1 -3.9,5l-0.1,0.5c-7,-4.2 -13.7,-9.4 -17.5,-16.6s-4.4,-16.5 0.3,-23.2"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M598.3,51a51,51 0,1 1,102 0a51,51 0,1 1,-102 0"
                    ).toNodes(),
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M741.3,11.9c-24.7,-3.3 -52.9,10 -59.3,34.1a21.6,21.6 0,0 0,-41.1 2.1l2.8,2a372.3,372.3 0,0 0,160.7 -0.7C787.2,31.3 766,15.2 741.3,11.9Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M635.3,79.9c-24.7,-3.3 -52.9,10 -59.3,34.1a21.6,21.6 0,0 0,-41.1 2.1l2.8,2a372.3,372.3 0,0 0,160.7 -0.7C681.2,99.3 660,83.2 635.3,79.9Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M719.2,317.7l-2.7,95.8 -2.7,95.3 -1.5,53.9a7.6,7.6 0,0 0,7.5 7.5,7.7 7.7,0 0,0 7.5,-7.5l2.7,-95.8 2.7,-95.3 1.5,-53.9a7.6,7.6 0,0 0,-7.5 -7.5,7.7 7.7,0 0,0 -7.5,7.5Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary)
        )
        addPath(
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M445.4,504.1a63.1,63.1 0,0 1,-20.1 33.7c-0.7,0.6 -1.5,1.3 -2.3,1.9q-2.8,0.3 -5.6,0.5c-1.5,0.1 -3,0.3 -4.5,0.4l-0.3,0 -0.2,-1.6 -0.8,-6.6a37.6,37.6 0,0 1,-3.3 -32.4c2.6,-7.1 7.4,-13.4 12.1,-19.7 6.5,-8.6 12.8,-17.1 13,-27.7a60.5,60.5 0,0 1,7.9 13.3,16.4 16.4,0 0,0 -5.1,3.8c-0.4,0.5 -0.8,1.1 -0.5,1.6 0.2,0.5 0.8,0.6 1.4,0.6 1.3,0.1 2.5,0.3 3.8,0.4 1,0.1 2,0.2 3,0.3a64,64 0,0 1,2.5 12.2A61.2,61.2 0,0 1,445.4 504.1Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary)
        )
        addPath(
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M419.2,535.1l-1.2,3.4 -0.6,1.7c-1.5,0.1 -3,0.3 -4.5,0.4l-0.3,0c-1.7,0.2 -3.3,0.3 -5,0.5 -0.4,-0.5 -0.9,-1 -1.3,-1.5a62,62 0,0 1,8.1 -87.1c-1.3,6.9 0.2,13.5 2.8,20.1 -0.3,0.1 -0.5,0.2 -0.8,0.3a16.4,16.4 0,0 0,-5.1 3.8c-0.4,0.5 -0.8,1.1 -0.5,1.6 0.2,0.5 0.8,0.6 1.4,0.6 1.3,0.1 2.5,0.3 3.8,0.4 1,0.1 2,0.2 3,0.3q0.7,0.1 1.4,0.2c0.1,0.2 0.1,0.3 0.2,0.4 2.9,6.2 5.9,12.4 7.7,18.8a43.7,43.7 0,0 1,1 4.9A37.6,37.6 0,0 1,419.2 535.1Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.tertiary)
        )
        addPath(
        ...
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M216.3,559a11,11 0,1 1,22 0a11,11 0,1 1,-22 0"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M717.3,559a11,11 0,1 1,22 0a11,11 0,1 1,-22 0"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M744.3,419a11,11 0,1 1,22 0a11,11 0,1 1,-22 0"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M712.3,317a11,11 0,1 1,22 0a11,11 0,1 1,-22 0"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M264.3,419a11,11 0,1 1,-0.2 -2.2A11,11 0,0 1,264.3 419Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M473.3,349a11,11 0,1 1,22 0a11,11 0,1 1,-22 0"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.tertiary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M375.3,349a11,11 0,1 1,-0.2 -2.2A11,11 0,0 1,375.3 349Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.tertiary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M233.3,317a11,11 0,1 1,-0.2 -2.2A11,11 0,0 1,233.3 317Z"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString(
                        "M410.25,338a16,16 0,1 1,32 0a16,16 0,1 1,-32 0"
                    ).toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.tertiary)
        )
        addPath(
            pathData =
                PathParser()
                    .parsePathString("M858.9,570.8l-857.8,0.3a1.2,1.2 0,1 1,0 -2.4l857.8,-0.3a1.2,1.2 0,0 1,0 2.4Z")
                    .toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.inverseSurface)
        )
    }.build()
