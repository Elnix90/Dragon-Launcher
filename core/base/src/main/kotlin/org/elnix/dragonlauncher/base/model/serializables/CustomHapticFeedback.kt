...
public value class CustomHapticFeedback(
    ...
    public companion object {
        ...
        public val singleTap: CustomHapticFeedback = build {
            haptic(20)
        }

        /** Vibrate, pause, vibrate */
        public val doubleTap: CustomHapticFeedback = build {
            haptic(20)
            pause(80)
            haptic(20)
        }
        ...
        /** Three quick pulses */
        public val tripleTap: CustomHapticFeedback = build {
            haptic(20)
            pause(60)
            haptic(20)
            pause(60)
        ...
        public val heavy: CustomHapticFeedback = build {
            haptic(80)
        }

        /** Short, pause, long */
        public val heartbeat: CustomHapticFeedback = build {
            haptic(20)
            pause(40)
            haptic(60)
        }
        ...
        /** Three uneven jolts */
        public val error: CustomHapticFeedback = build {
            haptic(50)
            pause(30)
            haptic(50)
            pause(30)
        ...
        /** Barely-there nudge */
        public val tick: CustomHapticFeedback = build {
            haptic(8)
        }

        /** Short then long, like a reward */
        public val success: CustomHapticFeedback = build {
            haptic(15)
            pause(50)
            haptic(40)
        }
        ...
        public val buzzRoll: CustomHapticFeedback = build {
            haptic(10)
            pause(20)
            haptic(10)
            pause(20)
        ...
        public val longPress: CustomHapticFeedback = build {
            haptic(60)
            pause(100)
            haptic(20)
        }
