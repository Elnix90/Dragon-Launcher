    ...
    constructor(
        ...
        public fun migrateFromLegacyBackup(content: String) {
            viewModelScope.launch {
                ...
                try {
                    val result =
                        migrationService.migrateFromBackupJson(
                            ctx = application,
                            legacyJson = content
                        )
         ...
         */
        public fun isLegacyBackup(jsonContent: String): Boolean = migrationService.isLegacyBackup(jsonContent)

        public fun isMigrationNeeded(): Boolean = migrationService.isMigrationNeeded(application)
