...
import org.elnix.dragonlauncher.common.serializables.SwipeAction.OpenDragonLauncherSettings
...
data class Point(
     ...
     */
    val holdAndRunAction: SwipeAction? = null
    ...
    companion object {
        ...
        fun Point.applyColorAction(): Boolean = (
                action !is SwipeAction.LaunchApp &&
        ...
        object PointsJson: DragonJson<List<Point>>()
    }
}