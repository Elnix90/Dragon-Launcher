package org.elnix.dragonlauncher.ui.base.components.sheets
...
import org.elnix.dragonlauncher.ui.base.overlays.Overlay

// Stolen from https://github.com/MM2-0/Kvaesitso/tree/main/app/ui/src/main/java/de/mm20/launcher2/ui/component
    ...
    if (expandedCurrent || expandedTarget) {
        ...
        Overlay {
            ...
            BoxWithConstraints(
                ...
                val containerHeight = maxHeight.px
