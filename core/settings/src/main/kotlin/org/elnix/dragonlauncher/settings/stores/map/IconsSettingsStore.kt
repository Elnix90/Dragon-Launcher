...
public object IconsSettingsStore : MapSettingsStore() {
    @SettingKey
    public val selectedIconPack: StringSettingObject =
        string(
    ...
    @SettingKey
    public val useIconTint: BooleanSettingObject =
        boolean(
    ...
    @SettingKey
    public val iconsTint: ColorSettingObject =
        color(
    ...
    @SettingKey
    public val onlyTintIconPack: BooleanSettingObject =
        boolean(
    ...
    @SettingKey
    public val renderForeground: BooleanSettingObject =
        boolean(
    ...
    @SettingKey
    public val renderBackground: BooleanSettingObject =
        boolean(
    ...
    @SettingKey
    public val themedIcons: BooleanSettingObject =
        boolean(
    ...
    @SettingKey
    public val forceThemed: BooleanSettingObject =
        boolean(
    ...
    @SettingKey
    public val adaptify: BooleanSettingObject =
        boolean(
