...
public object WellbeingSettingsStore : MapSettingsStore() {
     ...
     */
    @SettingKey
    public val socialMediaPauseEnabled: BooleanSettingObject =
        boolean(
     ...
     */
    @SettingKey
    public val guiltModeEnabled: BooleanSettingObject =
        boolean(
     ...
     */
    @SettingKey
    public val pauseDurationSeconds: IntSettingObject =
        int(
     ...
     */
    @SettingKey
    public val reminderEnabled: BooleanSettingObject =
        boolean(
     ...
     */
    @SettingKey
    public val reminderIntervalMinutes: IntSettingObject =
        int(
     ...
     */
    @SettingKey
    public val reminderMode: EnumSettingObject<ReminderMode> =
        enum(
            title = R.string.mode,
     ...
     */
    @SettingKey
    public val popupShowSessionTime: BooleanSettingObject =
        boolean(
     ...
     */
    @SettingKey
    public val popupShowTodayTime: BooleanSettingObject =
        boolean(
     ...
     */
    @SettingKey
    public val popupShowRemainingTime: BooleanSettingObject =
        boolean(
     ...
     */
    @SettingKey
    public val returnToLauncherEnabled: BooleanSettingObject =
        boolean(
