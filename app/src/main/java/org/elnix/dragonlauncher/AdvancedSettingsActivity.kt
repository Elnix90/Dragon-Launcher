...
import org.elnix.dragonlauncher.ui.AdvancedSettingsUi
...
class AdvancedSettingsActivity : ComponentActivity() {
    val backupVm by this.viewModels<BackupViewModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            UiSettingsStore.getFullscreen(this@AdvancedSettingsActivity).collectLatest { enabled ->
                if (enabled) {
                    controller.hide(
